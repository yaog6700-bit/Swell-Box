...
var zh = map[string]string{
	...
	"cfg_import_fixed":  "已自动修复 %d 个空节点组",
...
var en = map[string]string{
	...
	"cfg_import_fixed":  "auto-fixed %d empty outbound group(s)",
